...
export class AccountButton extends LitElement {
  ...
  render() {
    ...
    return html`
      <button
        @click="${this.open}"
        class="w-full border p-[4px] rounded-lg flex cursor-pointer border-red-600/50 bg-red-600 hover:bg-red-700 justify-center items-center transition-colors duration-200"
        title="${buttonTitle}"
      >
        ${this.renderIcon()}
      </button>
