...
export class Leaderboard extends LitElement implements Layer {
  ...
  render() {
    ...
    return html`
      ...
      >
        <div
          class="grid bg-red-950/70 w-full text-xs md:text-xs lg:text-sm border border-red-800/30"
          style="grid-template-columns: 30px 100px 70px 55px 75px;"
        >
          <div class="contents font-bold bg-red-900/50">
            <div class="py-1 md:py-2 text-center border-b border-red-700/50">
              #
            </div>
            <div class="py-1 md:py-2 text-center border-b border-red-700/50">
            ...
            <div
              class="py-1 md:py-2 text-center border-b border-red-700/50 cursor-pointer whitespace-nowrap"
          ...
          ${repeat(
            ...
            (player) => html`
              <div
                class="contents hover:bg-red-800/40 ${player.isOnSameTeam
                  ? "font-bold"
                  : ""} cursor-pointer"
              ...
              >
                ...
                <div
                  class="py-1 md:py-2 text-center border-b border-red-700/30 truncate"
                >
                  ${player.name}
                </div>
                <div class="py-1 md:py-2 text-center border-b border-red-700/30">
      ...
      <button
        class="mt-1 px-1.5 py-0.5 md:px-2 md:py-0.5 text-xs md:text-xs lg:text-sm border border-red-700/40 hover:bg-red-800/30 text-white mx-auto block"
        @click=${() => {
