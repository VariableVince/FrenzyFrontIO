...
export class GameRightSidebar extends LitElement implements Layer {
  ...
  render() {
    ...
    return html`
      <aside
        class=${`flex flex-col max-h-[calc(100vh-80px)] overflow-y-auto p-2 bg-red-950/70 backdrop-blur-sm shadow-xs rounded-tl-lg rounded-bl-lg transition-transform duration-300 ease-out transform border-l border-red-800/30 ${
      ...
      >
        ...
        <div class="flex justify-center items-center mt-2">
          <div
            class="w-[70px] h-8 lg:w-24 lg:h-10 border border-red-700/50 p-0.5 text-xs md:text-sm lg:text-base flex items-center justify-center text-white px-1"
